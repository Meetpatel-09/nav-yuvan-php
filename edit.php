               ...
               <form class="row g-3" method="POST" enctype="multipart/form-data" netlify>
                    ...
                    <div class="col-md-6">
                         ...
                         <input type="text" class="form-control" name="father_name" id="inputFaterName"
                              value="<?php echo $father_name; ?>" required>
                    </div>
                    ...
                    <div class="col-md-6">
                         ...
                         <input type="text" class="form-control" name="father_native_place" id="inputFaterNativePlace"
                              value="<?php echo $father_native_place; ?>" required>
                    </div>
                    <div class="col-md-6">
                         ...
                         <input type="text" class="form-control" name="mother_name" id="inputMotherName"
                              value="<?php echo $mother_name; ?>" required>
                    </div>
                    <div class="col-md-6">
                         ...
                         <input type="text" class="form-control" name="mother_native_place" id="inputMotherNativePlace"
                              value="<?php echo $mother_native_place; ?>" required>
                    </div>
                    <div class="col-6">
                    ...
                    <div class="col-6">
                         ...
                         <div class="form-check form-check-inline">
                              <input class="form-check-input" type="radio" name="marital_status" id="inlineRadio1"
                                   value="Unmarried" <?php echo ($marital_status == "Unmarried") ? "Checked" : ""; ?>>
                         ...
                         <div class="form-check form-check-inline">
                              <input class="form-check-input" type="radio" name="marital_status" id="inlineRadio2"
                                   value="Divorcee" <?php echo ($marital_status == "Divorcee") ? "Checked" : ""; ?>>
                    ...
                    <div class="col-md-6">
                         ...
                         <input type="date" class="form-control" name="birth_date" id="inputDateOfBirth"
                    ...
                    <div class="col-md-6">
                         ...
                         <input type="text" class="form-control" name="birth_time" id="inputTimeOfBirth"
                              style="width: 40%; display: inline" value="<?php echo $birth_time ?>" required>
                         <select class=" form-select" name="birth_time_ampm" title="birth_time_ampm"
                         ...
                         <select class=" form-select" name="birth_time_morining" title="birth_time_morining"
                              style="width: auto; display: inline" required>
                    ...
                    <div class="col-md-6">
                         ...
                         <input type="text" class="form-control" name="birth_place" id="inputBirthPlace"
                              value="<?php echo $birth_place; ?>" required>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                         ...
                         <input type="tel" class="form-control" name="mobile_number_one" id="inputMobile"
                              value="<?php echo $mobile_number_one; ?>" required>
                    </div>
                    <div class="col-md-6">
                         ...
                         <input type="tel" class="form-control" name="mobile_number_two" id="inputMobile2"
                              value="<?php echo $mobile_number_two; ?>">
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                         ...
                         <textarea class="form-control" name="address"
                              id="inputAddress"><?php echo $address; ?></textarea>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-md-6">
                         ...
                         <input type="text" class="form-control" name="profession" id="inputProfession"
                              value="<?php echo $profession; ?>" required>
                    </div>
                    <div class="col-md-6">
                         ...
                         <input type="text" class="form-control" name="monthly_income" id="inputMonthlyIncome"
                              value="<?php echo $monthly_income; ?>">
                    </div>
                    <div class="col-12">
                         <label for="inputAboutYou" class="form-label">About You</label>
                         <textarea class="form-control" name="about_you"
                              id="inputAboutYou"><?php echo $about_you; ?></textarea>
                    </div>

                    <div class="form-check form-check-inline">
                         <input class="form-check-input" type="checkbox" name="confirm" id="confirm" value="true"
                              required>
