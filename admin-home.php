                    ...
                    <tbody>
                         ...
                         ?>
                              <tr>
                                   ...
                                   <td><img class="rounded-circle" height="75px" width="75px" alt="avatar1" src="uploaded_images/<?php echo $row['profile_photo'] ?>" /></td>
                                   <td><?php echo $row['name'] . " " . $row['father_name'] . " " . $row['surname'] ?></td>
                                   <td><?php echo $row['mobile_number_one']; ?></td>
                                   <td><?php echo $row['email'] ?></td>
                                   <!-- <td>@mdo</td> -->
                                   <td><a href="a-view.php?user_id=<?php echo $row['user_id'] ?>" class="btn btn-primary">View</a></td>
                                   <!-- <td><button class="btn btn-success">Print</button></td> -->
                                   <!-- <td><button class="btn btn-warning">Edit</button></td> -->
                                   <!-- <td><button class="btn btn-danger">Remove</button></td> -->

                                   <td><a href="remove-user.php?user_id=<?php echo $row['user_id']; ?>" type="button" class="btn btn-danger">Remove</a></td>
